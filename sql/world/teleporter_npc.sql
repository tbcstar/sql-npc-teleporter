/*
Based upon the work by Rochet2 "TrinityCore Portal Master"
Download it from from http://rochet2.github.io/

Updated by Zoidwaffle to work with Azerothcore, all credits to the original author.
*/
...
(@TEXT_ID+4, "$B请选择你想传送的-地点?$B", 0),
(@TEXT_ID+3, "$B请选择你想传送的-团队副本?该区无法回传.$B", 0),
(@TEXT_ID+2, "$B请选择你想传送的-副本?$B", 0),
(@TEXT_ID+1, "$B 联盟地区!$B", 6),
(@TEXT_ID,  "$B 部落地区!", 6);
...
(14, @GOSSIP_MENU, @TEXT_ID+1, 6, 469, "联盟地区"),
(14, @GOSSIP_MENU, @TEXT_ID, 6, 67, "部落地区");
...
(15, @GOSSIP_MENU+8, 9, 27, 77, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 8, 27, 77, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 7, 27, 77, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 6, 27, 77, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 5, 27, 76, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 4, 27, 74, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 3, 27, 73, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 2, 27, 71, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 1, 27, 68, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+8, 0, 27, 68, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 6, 27, 67, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 5, 27, 67, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 4, 27, 65, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 3, 27, 64, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 2, 27, 62, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 1, 27, 60, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+7, 0, 27, 58, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 18, 27, 55, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 17, 27, 55, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 16, 27, 48, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 15, 27, 48, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 14, 27, 45, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 13, 27, 40, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 12, 27, 40, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 11, 27, 35, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 10, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 9, 27, 25, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 8, 27, 18, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 7, 27, 15, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 6, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 5, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+6, 4, 27, 15, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 23, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 22, 27, 53, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 21, 27, 51, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 20, 27, 50, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 19, 27, 45, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 18, 27, 43, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 17, 27, 40, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 16, 27, 35, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 15, 27, 35, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 14, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 13, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 12, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 11, 27, 20, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 10, 27, 20, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 9, 27, 18, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 8, 27, 15, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 7, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 6, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 5, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+5, 4, 27, 10, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 22, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 21, 27, 57, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 19, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 18, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 17, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 16, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 15, 27, 60, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 14, 27, 67, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 13, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 12, 27, 60, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 11, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 10, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 9, 27, 60, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 8, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 7, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 6, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 5, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 4, 27, 80, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 3, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 2, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 1, 27, 60, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+4, 0, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 11, 27, 75, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 10, 27, 69, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 9, 27, 77, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 8, 27, 79, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 7, 27, 75, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 6, 27, 71, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 5, 27, 79, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 4, 27, 71, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 3, 27, 74, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 2, 27, 79, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 1, 27, 79, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+3, 0, 27, 73, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 5, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 4, 27, 70, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 3, 27, 59, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 2, 27, 62, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 1, 27, 66, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+2, 0, 27, 64, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 18, 27, 35, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 17, 27, 37, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 16, 27, 47, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 15, 27, 55, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 14, 27, 55, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 13, 27, 45, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 12, 27, 55, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 11, 27, 57, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 10, 27, 53, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 9, 27, 21, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 8, 27, 17, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 7, 27, 18, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 6, 27, 32, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 5, 27, 24, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 4, 27, 34, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 3, 27, 15, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 2, 27, 22, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 1, 27, 17, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU+1, 0, 27, 25, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 20, 27, 57, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 19, 27, 69, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 18, 27, 59, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 17, 27, 15, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 16, 27, 68, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 15, 27, 58, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 12, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 11, 27, 30, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 10, 27, 57, 3, 0, "传送器-等级要求"),
(15, @GOSSIP_MENU, 9, 27, 67, 3, 0, "传送器-等级要求");
...
(@GOSSIP_MENU, 5, 2, "埃索达", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定，你想要去埃索达?"),
(@GOSSIP_MENU, 6, 2, "雷霆崖", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定，你想要去雷霆崖?"),
...
(@GOSSIP_MENU, 10, 2, "沙塔斯城", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定，你想要去沙塔斯城?"),
(@GOSSIP_MENU, 11, 2, "藏宝海湾", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定，你想要去藏宝海湾?"),
(@GOSSIP_MENU, 12, 2, "古拉巴什竞技场", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定，你想要去古拉巴什竞技场?"),
...
(@GOSSIP_MENU, 17, 9, "经典旧世副本", 1, 1, @GOSSIP_MENU+1, 0, 0, 0, NULL),
(@GOSSIP_MENU, 18, 9, "燃烧远征副本", 1, 1, @GOSSIP_MENU+2, 0, 0, 0, NULL),
(@GOSSIP_MENU, 19, 9, "巫妖王副本", 1, 1, @GOSSIP_MENU+3, 0, 0, 0, NULL),
...
(@GOSSIP_MENU+1, 2, 2, "监狱", 1, 1, 0, 0, 0, 0, "你确定，你想要去监狱?"),
...
(@GOSSIP_MENU+1, 16, 2, "沉没的神庙", 1, 1, 0, 0, 0, 0, "你确定，你想要去沉没的神庙?"),
...
(@GOSSIP_MENU+3, 0, 2, "埃兹卓-尼鲁布", 1, 1, 0, 0, 0, 0, "你确定，你想要去埃兹卓-尼鲁布?"),
(@GOSSIP_MENU+3, 1, 2, "净化斯坦索姆", 1, 1, 0, 0, 0, 0, "你确定，你想要去净化斯坦索姆?"),
(@GOSSIP_MENU+3, 2, 2, "冠军试炼", 1, 1, 0, 0, 0, 0, "你确定，你想要去冠军试炼?"),
(@GOSSIP_MENU+3, 3, 2, "达克萨隆要塞", 1, 1, 0, 0, 0, 0, "你确定，你想要去达克萨隆要塞?"),
(@GOSSIP_MENU+3, 4, 2, "古达克", 1, 1, 0, 0, 0, 0, "你确定，你想要去古达克?"),
(@GOSSIP_MENU+3, 5, 2, "映像大厅", 1, 1, 0, 0, 0, 0, "你确定，你想要去映像大厅?"),
(@GOSSIP_MENU+3, 6, 2, "奥核之心", 1, 1, 0, 0, 0, 0, "你确定，你想要去奥核之心?"),
...
(@GOSSIP_MENU+3, 10, 2, "乌特加德要塞", 1, 1, 0, 0, 0, 0, "你确定，你想要去乌特加德要塞?"),
(@GOSSIP_MENU+3, 11, 2, "乌特加德之巅", 1, 1, 0, 0, 0, 0, "你确定，你想要去乌特加德之巅?"),
(@GOSSIP_MENU+3, 12, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "黑暗神庙", 1, 1, 0, 0, 0, 0, "你确定，你想要去黑暗神庙?"),
(@GOSSIP_MENU+4, 1, 2, "黑翼之巢", 1, 1, 0, 0, 0, 0, "你确定，你想要去黑翼之巢?"),
(@GOSSIP_MENU+4, 2, 2, "海加尔山", 1, 1, 0, 0, 0, 0, "你确定，你想要去海加尔山?"),
(@GOSSIP_MENU+4, 3, 2, "毒蛇神殿", 1, 1, 0, 0, 0, 0, "你确定，你想要去毒蛇神殿?"),
(@GOSSIP_MENU+4, 4, 2, "十字军试炼", 1, 1, 0, 0, 0, 0, "你确定，你想要去十字军试炼?"),
(@GOSSIP_MENU+4, 5, 2, "戈鲁尔之巢", 1, 1, 0, 0, 0, 0, "你确定，你想要去戈鲁尔之巢?"),
(@GOSSIP_MENU+4, 6, 2, "玛瑟里顿的巢穴", 1, 1, 0, 0, 0, 0, "你确定，你想要去玛瑟里顿的巢穴?"),
(@GOSSIP_MENU+4, 7, 2, "冰冠冰川", 1, 1, 0, 0, 0, 0, "你确定，你想要去冰冠冰川?"),
...
(@GOSSIP_MENU+4, 11, 2, "奥妮克希亚的", 1, 1, 0, 0, 0, 0, "你确定，你想要去奥妮克希亚的?"),
(@GOSSIP_MENU+4, 12, 2, "安其拉废墟", 1, 1, 0, 0, 0, 0, "你确定，你想要去安其拉废墟?"),
(@GOSSIP_MENU+4, 13, 2, "太阳井高地", 1, 1, 0, 0, 0, 0, "你确定，你想要去太阳井高地?"),
(@GOSSIP_MENU+4, 14, 2, "风暴之眼", 1, 1, 0, 0, 0, 0, "你确定，你想要去风暴之眼?"),
(@GOSSIP_MENU+4, 15, 2, "安其拉神庙", 1, 1, 0, 0, 0, 0, "你确定，你想要去安其拉神庙?"),
...
(@GOSSIP_MENU+5, 0, 2, "闪金镇", 1, 1, 0, 0, 0, 0, "你确定，你想要去闪金镇?"),
...
(@GOSSIP_MENU+5, 20, 2, "燃烧平原", 1, 1, 0, 0, 0, 0, "你确定，你想要去燃烧平原?"),
...
(@GOSSIP_MENU+6, 4, 2, "血谜岛", 1, 1, 0, 0, 0, 0, "你确定，你想要去血谜岛?"),
...
(@GOSSIP_MENU+6, 8, 2, "灰谷", 1, 1, 0, 0, 0, 0, "你确定，你想要去灰谷?"),
...
(@GOSSIP_MENU+6, 13, 2, "塔纳利斯", 1, 1, 0, 0, 0, 0, "你确定，你想要去塔纳利斯?"),
...
(@GOSSIP_MENU+8, 4, 2, "祖阿曼", 1, 1, 0, 0, 0, 0, "你确定，你想要去祖阿曼?"),
(@GOSSIP_MENU+8, 5, 2, "索拉查盆地", 1, 1, 0, 0, 0, 0, "你确定，你想要去索拉查盆地?"),
(@GOSSIP_MENU+8, 6, 2, "晶格森林", 1, 1, 0, 0, 0, 0, "你确定，你想要去晶格森林?"),
...
INSERT INTO creature (id, map, spawnMask, phaseMask, modelid, position_x, position_y, position_z, orientation, spawntimesecs, curhealth, curmana) VALUES
(@ENTRY, 0, 1, 1, 0, -13180.5, 342.503, 43.1936, 4.32977, 25, 13700, 6540), 
(@ENTRY, 530, 1, 1, 0, -3862.69, -11645.8, -137.629, 2.38273, 25, 13700, 6540), 
(@ENTRY, 0, 1, 1, 0, -4898.37, -965.118, 501.447, 2.25986, 25, 13700, 6540), 
(@ENTRY, 0, 1, 1, 0, -8845.09, 624.828, 94.2999, 0.44062, 25, 13700, 6540), 
(@ENTRY, 1, 1, 1, 0, 1599.25, -4375.85, 10.0872, 5.23641, 25, 13700, 6540), 
(@ENTRY, 1, 1, 1, 0, -1277.65, 72.9751, 128.742, 5.95567, 25, 13700, 6540), 
(@ENTRY, 0, 1, 1, 0, 1637.21, 240.132, -43.1034, 3.13147, 25, 13700, 6540), 
(@ENTRY, 530, 1, 1, 0, 9741.67, -7454.19, 13.5572, 3.14231, 25, 13700, 6540), 
(@ENTRY, 571, 1, 1, 0, 5807.06, 506.244, 657.576, 5.54461, 25, 13700, 6540), 
(@ENTRY, 1, 1, 1, 0, 9866.83, 2494.66, 1315.88, 5.9462, 25, 13700, 6540), 
(@ENTRY, 0, 1, 1, 0, -14279.8, 555.014, 8.90011, 3.97606, 25, 13700, 6540), 
(@ENTRY, 530, 1, 1, 0, -1888.65, 5355.88, -12.4279, 1.25883, 25, 13700, 6540);
